...
export default function Home() {
  ...
  const t = {
    en: {
      ...
      stats_2: '50+',
      stats_2_label: 'Industries',
      stats_3: '100%',
      stats_3_label: 'Anonymous',
    ...
    ar: {
      ...
      nav_coach: 'مساعد AI',
      nav_companies: 'هل راتبك عادل؟',
      toggle: 'English',
      hero_title: 'اعرف قيمتك.',
      hero_sub: 'أول منصة رواتب مجهولة الهوية مبنية خصيصاً لمنطقة الشرق الأوسط وشمال أفريقيا. رواتب حقيقية. باقات حقيقية. بدون مبالغة.',
      search_placeholder: 'ابحث بالمسمى الوظيفي أو الشركة أو الدولة...',
      search_btn: 'بحث',
      stats_1: '22',
      stats_1_label: 'دولة عربية',
      stats_2: '+50',
      stats_2_label: 'قطاع',
      stats_3: '%100',
      stats_3_label: 'سري تماماً',
      submit_cta: 'شارك راتبك بشكل مجهول',
      submit_sub: 'لا حساب مطلوب. 90 ثانية فقط. ساعد غيرك يعرف قيمته الحقيقية.',
      submit_btn: 'ابدأ الآن ←',
      features_title: 'كل ما أغفله Glassdoor عن منطقتنا',
      f1_title: 'تفاصيل الباقة كاملة',
      f1_desc: 'الراتب الأساسي، السكن، المواصلات، المكافآت، تذاكر السفر — الصورة الكاملة.',
      f2_title: 'مساعد التفاوض بالذكاء الاصطناعي',
      f2_desc: 'احصل على نص تفاوضي شخصي لعرضك القادم مبني على بيانات السوق الحقيقية.',
      f3_title: 'عربي وإنجليزي',
      f3_desc: 'مبني للمنطقة من الأساس. تبديل فوري بين اللغتين.',
      f4_title: 'سرية تامة 100%',
    ...
    <div dir={isAr ? 'rtl' : 'ltr'} style={{ fontFamily: 'Inter, sans-serif', background: '#0a0a0f', minHeight: '100vh', color: '#fff' }}>
      ...
      <section style={{ textAlign: 'center', padding: '120px 40px 80px', maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ display: 'inline-block', background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '50px', padding: '6px 16px', fontSize: '13px', color: '#a78bfa', marginBottom: '24px', fontWeight: '500' }}>
          🚀 {isAr ? 'متاح الآن — أول منصة شفافية رواتب في المنطقة' : 'Now live — MENA\'s first salary transparency platform'}
        </div>
